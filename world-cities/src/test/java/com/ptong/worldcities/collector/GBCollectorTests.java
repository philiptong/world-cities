...
import com.ptong.worldcities.collector.region.GBCollector;
...
public class GBCollectorTests {

    public static final String COUNTRY_CODE = GBCollector.COUNTRY_CODE;
