...
import com.ptong.worldcities.collector.region.MYSRegionCollector;
...
public class MYSRegionCollectorTests {

    private final String REGION_HTML_FILE_PATH = FileUtils.getTestResourcesFolder() + "/mys/regions_html";
    private final String DISTRICT_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/mys/districts_json";
    private final String REGION_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/mys/regions_json";

    @Test
    public void shouldParseDistrictHtml() throws IOException, InterruptedException {
        MYSRegionCollector collector = new MYSRegionCollector();
        ...
        Assertions.assertTrue(districts.size() == 16);
    }
