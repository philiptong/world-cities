...
import com.ptong.worldcities.collector.region.DECollector;
...
public class DECollectorTests {

    public static final String COUNTRY_CODE = DECollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        DECollector collector = new DECollector();
