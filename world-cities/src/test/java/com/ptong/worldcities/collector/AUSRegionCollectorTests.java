...
public class AUSRegionCollectorTests {

    private final String REGION_HTML_FILE_PATH = FileUtils.getTestResourcesFolder() + "/aus/regions_html";
    private final String DISTRICT_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/aus/districts_json";
    private final String REGION_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/aus/regions_json";
    ...
    public void shouldParseDistrictHtml() throws IOException, InterruptedException {
        ...
        Assertions.assertTrue(districts.size() == 8);
    }
    ...
    public void shouldParseRegionHtml() throws IOException, InterruptedException {
        ...
        Assertions.assertTrue(regions.size() == 8);
    }
