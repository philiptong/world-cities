...
import com.ptong.worldcities.collector.region.JPCollector;
...
public class JPCollectorTests {

    public static final String COUNTRY_CODE = JPCollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        JPCollector collector = new JPCollector();
