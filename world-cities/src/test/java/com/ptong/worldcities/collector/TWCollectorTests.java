...
import com.ptong.worldcities.collector.region.TWCollector;
...
public class TWCollectorTests {

    public static final String COUNTRY_CODE = TWCollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        TWCollector collector = new TWCollector();
