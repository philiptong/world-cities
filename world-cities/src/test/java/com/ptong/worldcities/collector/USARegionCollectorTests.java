...
import com.ptong.worldcities.collector.region.USARegionCollector;
...
public class USARegionCollectorTests {
    ...
    public void shouldParseDistrictHtml() throws IOException, InterruptedException {
        USARegionCollector collector = new USARegionCollector();
        ...
        Assertions.assertTrue(districts.size() == 57);
    }
