...
public class NZLRegionCollectorTests {
    ...
    private final String REGION_HTML_FILE_PATH = FileUtils.getTestResourcesFolder() + "/nzl/regions_html";
    private final String DISTRICT_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/nzl/districts_json";
    private final String REGION_JSON_FILE_PATH = FileUtils.getTestResourcesFolder() + "/nzl/regions_json";
