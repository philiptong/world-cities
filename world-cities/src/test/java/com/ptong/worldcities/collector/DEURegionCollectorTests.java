...
import com.ptong.worldcities.collector.region.DEURegionCollector;
...
public class DEURegionCollectorTests {
    ...
    public void shouldParseDistrictHtml() throws IOException, InterruptedException {
        DEURegionCollector collector = new DEURegionCollector();
