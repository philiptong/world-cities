...
import com.ptong.worldcities.collector.region.KRCollector;
...
public class KRCollectorTests {

    public static final String COUNTRY_CODE = KRCollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        KRCollector collector = new KRCollector();
