...
import com.ptong.worldcities.collector.region.AUCollector;
...
public class AUCollectorTests {

    private static final String COUNTRY_CODE = AUCollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        AUCollector collector = new AUCollector();
