...
import com.ptong.worldcities.collector.region.NZCollector;
...
public class NZCollectorTests {

    public static final String COUNTRY_CODE = NZCollector.COUNTRY_CODE;
    ...
    public void shouldDownloadRegionHtml() throws IOException, InterruptedException {
        NZCollector collector = new NZCollector();
