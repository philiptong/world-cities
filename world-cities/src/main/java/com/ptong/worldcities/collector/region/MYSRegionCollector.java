...
public class MYSRegionCollector extends RegionCollector {

    private static final String COUNTRY_CODE = "MYS";
    private static final String REGIONS_RESOURCE_URI = "https://en.wikipedia.org/wiki/ISO_3166-2:MY";
    ...
    public List<District> parseDistrictHtml(String html) {
        ...
        rows.forEach(row -> {
            ...
            if (tds.size() > 0) {
                ...
                district.setName(tds.get(1).text().replace("Wilayah Persekutuan ", ""));
    ...
    public List<Region> parseRegionHtml(String html) {
        ...
        rows.forEach(row -> {
            ...
            if (tds.size() > 0) {
                ...
                region.setName(tds.get(1).text().replace("Wilayah Persekutuan ", ""));
